...
export default function ItemDetail({ producto }) {
	...
	return (
		<Box sx={{ background: "#f8f8f8", margin: "1rem", width: "300px", padding: "1rem", borderRadius: "10px", boxShadow: "5px 5px 5px #afafaf", height: "fit-content" }}>
			...
			: <Typography variant="body1" gutterBottom>Cargando...</Typography>
		}
		</Box>
	);
}